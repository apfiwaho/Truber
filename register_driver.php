    ...
    <header class="masthead" style="background-image:url('assets/img/header-bg.jpg');">
        <div class="container">
            <div class="intro-text">
                ...
                <form class="bootstrap-form-with-validation" action="signup_driver.php" method="POST">
                    ...
                    <div class="form-group"><label for="contact">Contact</label><input class="form-control" type="text" id="contact" name="contact" required></div>
                    ...
                    <div class="form-group"><label for="password-input">Confirm Password&nbsp;</label><input class="form-control" type="password" required id="password-input" name="current_password"></div>
